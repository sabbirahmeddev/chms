...
session_start();
global $dblink;
$dblink = mysqli_connect('localhost','root','','chbs');
	...
	function checkUser($admin=0, $ac = 0){
		if($admin==1 && $ac==0){
	...
	function nav(){
		if(!isset($_COOKIE['admin']) && !isset($_COOKIE['manager'])){    
		?>
			<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		      ...
		      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		        ...
		        <li class="nav-item dropdown">
		        	...
		        	<button class="btn btn-info my-2 my-sm-0" onclick="location.href='add_client.php'" >Register</button>&nbsp;&nbsp;&nbsp;
		    		<button class="btn btn-primary my-2 my-sm-0" onclick="location.href='login.php'" >Login</button>	          
		        </div>
		    </nav>
		...
		<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		      ...
		      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		        ...
		        <button class="btn btn-success my-2 my-sm-0" onclick="location.href='logout.php'" >Logout [admin]</button>
		        </div>
		    </nav>
			...
			<?php
		      ...
		      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		        ...
		        <button class="btn btn-success my-2 my-sm-0" onclick="location.href='logout.php'" >Logout [<?php echo getManager($_COOKIE['manager_id'])['name']?>]</button>
		        </div>
		    </nav>
				<?php
			} 
